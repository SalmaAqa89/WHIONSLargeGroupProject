...
urlpatterns = [
    ...
    path('verify-email/', AuthViews.verify_email, name='verify-email'),
    path('verify-email/done/', AuthViews.verify_email_done, name='verify-email-done'),
    path('verify-email-confirm/<uidb64>/<token>/', AuthViews.verify_email_confirm, name='verify-email-confirm'),
