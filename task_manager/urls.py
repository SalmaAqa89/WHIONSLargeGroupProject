...
urlpatterns = [
    ...
    path('search/', AuthViews.search_journal, name='search_journal'),
    path('search-suggestions/', AuthViews.search_suggestions, name='search-suggestions'),
    path('journal/<int:entry_id>/', AuthViews.journal_detail, name='journal_detail'),
    path('search-trash/', AuthViews.search_trash, name='search_trash'),
    path('search-suggestions1/', AuthViews.search_suggestions1, name='search-suggestions1'),
    path('search-favourite/', AuthViews.search_favourite, name='search_favourite'),
    path('search-favouritesuggestion/', AuthViews.search_favouriteSuggestion, name='search_favouriteSuggestion'),
